                ...
                <div class="section-card mb-4">
                    ...
                    <div class="section-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group"><input type="text" name="nama_ayah" value="{{ old('nama_ayah') }}" class="form-control @error('nama_ayah') is-invalid @enderror" placeholder="Nama ayah">@error('nama_ayah') <div class="invalid-feedback">{{ $message }}</div> @enderror</div>
                            <div class="col-md-6 form-group"><input type="text" name="nik_ayah" value="{{ old('nik_ayah') }}" class="form-control @error('nik_ayah') is-invalid @enderror" placeholder="NIK ayah">@error('nik_ayah') <div class="invalid-feedback">{{ $message }}</div> @enderror</div>
                            <div class="col-md-6 form-group"><input type="text" name="pekerjaan_ayah" value="{{ old('pekerjaan_ayah') }}" class="form-control @error('pekerjaan_ayah') is-invalid @enderror" placeholder="Pekerjaan ayah">@error('pekerjaan_ayah') <div class="invalid-feedback">{{ $message }}</div> @enderror</div>
                            <div class="col-md-6 form-group"><input type="text" name="penghasilan_ayah" value="{{ old('penghasilan_ayah') }}" class="form-control @error('penghasilan_ayah') is-invalid @enderror" placeholder="Penghasilan ayah">@error('penghasilan_ayah') <div class="invalid-feedback">{{ $message }}</div> @enderror</div>

                            <div class="col-12 mt-3 mb-2 form-span-2"><h6 class="mb-0">Data Ibu</h6></div>
                            <div class="col-md-6 form-group"><input type="text" name="nama_ibu" value="{{ old('nama_ibu') }}" class="form-control @error('nama_ibu') is-invalid @enderror" placeholder="Nama ibu">@error('nama_ibu') <div class="invalid-feedback">{{ $message }}</div> @enderror</div>
                            <div class="col-md-6 form-group"><input type="text" name="nik_ibu" value="{{ old('nik_ibu') }}" class="form-control @error('nik_ibu') is-invalid @enderror" placeholder="NIK ibu">@error('nik_ibu') <div class="invalid-feedback">{{ $message }}</div> @enderror</div>
                            <div class="col-md-6 form-group"><input type="text" name="pekerjaan_ibu" value="{{ old('pekerjaan_ibu') }}" class="form-control @error('pekerjaan_ibu') is-invalid @enderror" placeholder="Pekerjaan ibu">@error('pekerjaan_ibu') <div class="invalid-feedback">{{ $message }}</div> @enderror</div>
                            <div class="col-md-6 form-group"><input type="text" name="penghasilan_ibu" value="{{ old('penghasilan_ibu') }}" class="form-control @error('penghasilan_ibu') is-invalid @enderror" placeholder="Penghasilan ibu">@error('penghasilan_ibu') <div class="invalid-feedback">{{ $message }}</div> @enderror</div>

                            <div class="col-12 mt-3 mb-2 form-span-2"><h6 class="mb-0">Data Wali</h6></div>
                            <div class="col-md-6 form-group"><input type="text" name="nama_wali" value="{{ old('nama_wali') }}" class="form-control @error('nama_wali') is-invalid @enderror" placeholder="Nama wali">@error('nama_wali') <div class="invalid-feedback">{{ $message }}</div> @enderror</div>
                            <div class="col-md-6 form-group"><input type="text" name="pekerjaan_wali" value="{{ old('pekerjaan_wali') }}" class="form-control @error('pekerjaan_wali') is-invalid @enderror" placeholder="Pekerjaan wali">@error('pekerjaan_wali') <div class="invalid-feedback">{{ $message }}</div> @enderror</div>
                            <div class="col-md-6 form-group"><input type="text" name="no_hp_wali" value="{{ old('no_hp_wali') }}" class="form-control @error('no_hp_wali') is-invalid @enderror" placeholder="No HP wali">@error('no_hp_wali') <div class="invalid-feedback">{{ $message }}</div> @enderror</div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-12 form-group">
                                ...
                                <select name="pilihan_jurusan" class="custom-select form-control @error('pilihan_jurusan') is-invalid @enderror">
                                    ...
                                    @foreach($jurusanList as $jurusan)
                                        <option value="{{ $jurusan }}" {{ old('pilihan_jurusan') == $jurusan ? 'selected' : '' }}>{{ $jurusan }}</option>
                                    @endforeach
                                </select>
