...
<div class="p-6">
    <div class="flex flex-col md:flex-row justify-between items-center mb-6">
        <h2 class="text-2xl font-bold text-gray-800">Kelola Pemesanan Seragam</h2>
            ...
            <table class="w-full text-left">
                <thead class="bg-gray-50 border-b border-gray-100">
                    <tr>
                        ...
                        <th class="px-6 py-4 font-semibold text-gray-700">Ukuran</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition duration-150">
                        ...
                        <td class="px-6 py-4 text-sm text-gray-600">{{ \->ukuran }}</td>
                        <td class="px-6 py-4">
                            @if(\->status == 'Selesai')
                                <span class="px-3 py-1 text-xs font-semibold text-green-700 bg-green-100 rounded-full">Selesai</span>
                            @elseif(\->status == 'Proses')
                                <span class="px-3 py-1 text-xs font-semibold text-blue-700 bg-blue-100 rounded-full">Proses</span>
                            @else
                                <span class="px-3 py-1 text-xs font-semibold text-amber-700 bg-amber-100 rounded-full">{{ \->status }}</span>
                            @endif
                        </td>
